...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference("Medicine.count") do
      post medicines_url, params: { medicine: { category: @medicine.category, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { category: @medicine.category, name: @medicine.name, price: @medicine.price, quantity: @medicine.quantity } }
