...
class ClinicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clinic" do
    assert_difference("Clinic.count") do
      post clinics_url, params: { clinic: { hospital_id: @clinic.hospital_id, location: @clinic.location, name: @clinic.name } }
    end
  ...
  test "should update clinic" do
    patch clinic_url(@clinic), params: { clinic: { hospital_id: @clinic.hospital_id, location: @clinic.location, name: @clinic.name } }
